...
export default function HvGrey({
  sections,
}: SplitSectionProps) {
  const CheckIcon = () => (
  ...
  return (
    <section className="bg-[#F5F5F5] space-y-8 md:space-y-20 py-8 md:py-20">
      ...
      {sections.map((section, index) => (
        ...
        >
          ...
          <div className={`${section.reverse ? "lg:order-2" : ""}`}>
            ...
            <SectionHeading
              title={section.title}
              className="text-[20px] md:text-[43px] font-normal text-black mb-5 leading-tight text-left"
            />
