...
export default function SplitSection() {
    return (
        <section className="bg-white md:space-y-20 md:py-8">
            ...
            {/* SECTION 1 */}
            <div className="max-w-[1440px] w-[90%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 items-center pb-5 md:pb-0">
    ...
    <div className="relative w-full h-[220px] sm:h-[300px] lg:h-full rounded-[24px] overflow-hidden border border-[#D7D7D7] order-2 lg:order-1">
        ...
        />
            ...
            {/* SECTION 2 */}
            <div className="max-w-[1440px] w-[90%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-5 md:gap-10 items-center border-t-1 border-[#D7D7D7] pt-8 md:pt-20">
