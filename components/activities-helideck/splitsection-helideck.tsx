...
export default function SplitSectionHelideck({
  ...
  return (
    <section className="bg-white space-y-20 py-20">
      {sections.map((section, index) => (
        <div
          key={index}
          className={`max-w-[1440px] w-[90%] mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center`}
        >
          {/* Content */}
          ...
          {/* Image */}
          <div
            className={`relative w-full h-full rounded-[24px] overflow-hidden border border-[#D7D7D7] ${
