    ...
    return (
        <section className="w-full bg-white py-10 md:py-16 lg:py-20">
            <div className="max-w-[1440px] w-[90%] md:w-[85%] mx-auto">
                <div className="flex flex-col lg:flex-row items-stretch overflow-hidden shadow-[0_8px_40px_rgba(0,0,0,0.12)]">

                    {/* Left — Image */}
                    <div className="relative w-full lg:w-[55%] min-h-[300px] lg:min-h-[600px] rounded-[16px]">
                        <Image
                    ...
                    <div className="w-full lg:w-[55%] bg-white px-6 py-8 md:px-10 md:py-10 lg:py-12 flex flex-col justify-center lg:max-h-[600px]">
                        <h2 className="font-rethink text-[26px] md:text-[32px] lg:text-[36px] font-bold text-[#111827] mb-1.5 leading-tight">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    <select
                                        ...
                                        onChange={handleChange}
                                        className={`${inputBase} appearance-none pr-10 cursor-pointer ${formData.service === "" ? "text-[#ADAFB5]" : "text-black"
                                            }`}
                                    >
                                        <option value="" disabled>Select a Service</option>
                                        <option value="helipad-solutions">Helipad Solutions</option>
                                        <option value="vertiport-solutions">Vertiport Solutions</option>
                                        <option value="obstruction-lighting">Obstruction Lighting</option>
                                        <option value="floating-platforms">Floating Platforms</option>
