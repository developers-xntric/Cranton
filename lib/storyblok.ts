...
export function normalizeStoryblokValue<T>(value: T): T {
...
export async function getStoryblokStoryContent(
  slug: string
  ...
  try {
    ...
    return storyContent && typeof storyContent === "object"
      ? (normalizeStoryblokValue(storyContent) as Record<string, unknown>)
      : null;
  } catch {
    return null;
  }
