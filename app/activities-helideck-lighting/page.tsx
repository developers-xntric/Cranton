...
const fallbackContent = {
  hero: { title: "Helideck Lighting", backgroundImage: "/helideck-lighting/hero.png" },
  intro: {
    topImages: ["/helideck-lighting/helipad.png"],
  ...
  features: {
    ...
    features: [
      { icon: "/helideck-lighting/1.png", title: "Advanced LED Tech", desc: "High-efficiency LEDs for maximum visibility and energy savings." },
      { icon: "/helideck-lighting/2.png", title: "Weather Resistant", desc: "Designed to operate reliably in extreme marine and industrial climates." },
      { icon: "/helideck-lighting/3.png", title: "Global Compliance", desc: "Full adherence to ICAO Annex 14 and FAA lighting standards." },
      { icon: "/helideck-lighting/4.png", title: "Smart Control Systems", desc: "Centralized controllers for easy management of all lighting zones." },
    ],
  },
  sections: [
    {
...
const ActivitiesHelideckLighting = async () => {
  const rawContent = await getStoryblokStoryContent("activities-helideck-lighting");
