...
const fallbackContent = {
  hero: { title: "Helideck Manufacturing", backgroundImage: "/helideck-manufacturing/hero.png" },
  intro: {
    topImages: ["/helideck-manufacturing/manufacturing-1.png", "/helideck-manufacturing/manufacturing-2.png"],
  ...
  features: {
    ...
    features: [
      { icon: "/helideck-manufacturing/1.png", title: "End-to-End Execution", desc: "Detailed inspection to identify damage and performance issues." },
      { icon: "/helideck-manufacturing/2.png", title: "Custom Helideck Design", desc: "Provides effective repair and modernization of existing helidecks." },
      { icon: "/helideck-manufacturing/3.png", title: "High-Quality Materials", desc: "Ensures refurbished systems meet current aviation standards." },
      { icon: "/helideck-manufacturing/4.png", title: "Precision Engineering", desc: "Improves durability and extends the operational life of the helideck." },
    ],
  },
  sections: [
    {
...
const ActivitiesHelideckManufacturing = async () => {
  const rawContent = await getStoryblokStoryContent("activities-helideck-manufacturing");
