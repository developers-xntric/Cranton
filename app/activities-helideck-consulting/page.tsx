...
const fallbackContent = {
  hero: { title: "Helideck Consulting", backgroundImage: "/activities-helideck/hero.png" },
  intro: {
    image: "/helideck-consulting/helideck-consulting.png",
    imageAlt: "Helideck consulting",
  ...
  features: {
    ...
    features: [
      { icon: "/activities-helideck/1.png", title: "Expert Guidance", desc: "Provides professional consulting based on industry knowledge and experience." },
      { icon: "/activities-helideck/2.png", title: "Custom Project Planning ", desc: "We follow strict quality standards to ensure all systems are safe, reliable, and durable, every time." },
      { icon: "/activities-helideck/3.png", title: "Regulatory Compliance", desc: "Ensures all designs meet international aviation and safety standards." },
      { icon: "/activities-helideck/4.png", title: "End-to-End Support", desc: "Covers planning, design, approvals, and coordination." },
    ],
  },
  sections: [
    {
...
const ActivitiesHelideck = async () => {
  const rawContent = await getStoryblokStoryContent("activities-helideck-consulting");
