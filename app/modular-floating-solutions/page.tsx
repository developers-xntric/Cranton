...
const fallbackContent = {
  hero: { title: "Modular Floating Solutions", backgroundImage: "/mhero.png" },
  intro: {
    ...
    para: [
      "Easily deploy modular floating platforms across various water bodies, enabling stable operations without permanent marine.",
      "Reduces the need for heavy marine construction, offering a more efficient and budget-friendly solution.",
      "Engineered for buoyancy and balance, the system provides a secure, anti-slip surface suitable for both operational and recreational use.",
      "Adaptable for industrial, marine, leisure, and temporary setups, making it ideal for a wide range of floating applications.",
    ],
    titles: [
      "Flexible Deployment on Water Surfaces",
      "Cost-Effective Alternative to Fixed Structures",
      "Stable and Safe Platform Design",
  ...
  features: {
    ...
    features: [
      { icon: "/22.png", title: "Modular & Scalable Design", desc: "Interlocking units allow flexible configurations tailored to different project sizes and requirements." },
      { icon: "/333.png", title: "High Load Stability", desc: "Designed for balanced load distribution, ensuring safe and stable performance on water." },
      { icon: "/444.png", title: "Durable Weather Protection", desc: "Built with high-quality materials to withstand harsh marine and environmental conditions." },
      { icon: "/555.png", title: "Quick Installation", desc: "Simple assembly process enables fast deployment with minimal equipment and manpower." },
    ],
  },
  sections: [
    {
...
const ModularFloatingSolutions = async () => {
  const rawContent = await getStoryblokStoryContent("modular-floating-solutions");
