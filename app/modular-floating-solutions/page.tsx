...
import { getModularFloatingSolutionsPage } from "@/sanity/lib/content"
import { modularFloatingSolutionsDefaults as defaults } from "@/sanity/lib/modular-floating-solutions-defaults"
...
const dataForPage = async () => merge(defaults, await getModularFloatingSolutionsPage())

export default async function ModularFloatingSolutions() {
