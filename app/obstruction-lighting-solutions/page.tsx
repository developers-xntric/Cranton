...
const fallbackContent = {
  hero: { title: "Obstruction Lighting Solutions", backgroundImage: "/obstruction-lighting/hero.png" },
  intro: {
  ...
  features: {
    ...
    features: [
      { icon: "/portable-lighting/1.png", title: "High-Visibility Aviation Warning Systems", desc: "Designed to provide clear and reliable obstruction marking for enhanced airspace safety." },
      { icon: "/portable-lighting/2.png", title: "Durable Weather-Resistant Construction", desc: "Built to perform in harsh offshore, industrial, coastal, and remote environmental conditions." },
      { icon: "/portable-lighting/3.png", title: "Energy-Efficient LED Technology", desc: "Advanced LED systems deliver long operational life with low power consumption and minimal maintenance." },
      { icon: "/portable-lighting/4.png", title: "Compliant & Reliable Operation", desc: "Engineered to meet international aviation obstruction lighting standards for dependable continuous performance." },
    ],
  },
  lowerSections: [
    {
      ...
      description: "Low intensity lights are designed for structures with lower heights or where close-range visibility is required. These lights provide steady illumination to clearly mark obstacles in urban and controlled environments.",
      features: [
  ...
  upperSections: [
    {
      ...
      description: "High intensity obstruction lights are used for very tall structures where maximum visibility is critical. These systems ensure long-range detection and are essential for aviation safety in complex environments.",
      features: [
  ...
  steps: {
    ...
    steps: [
      { id: "01", title: "High-Intensity LED Technology", desc: "Delivers powerful illumination for maximum visibility in all conditions while maintaining energy efficiency.", image: "/obstruction-lighting/step1.png" },
      { id: "02", title: "Weather & Corrosion-Resistant Design", desc: "Built to withstand harsh environmental conditions, ensuring reliable performance over time.", image: "/obstruction-lighting/step2.png" },
      { id: "03", title: "Long Operational Lifespan", desc: "Engineered for extended use, reducing the need for frequent replacements.", image: "/obstruction-lighting/step3.png" },
      { id: "04", title: "Low Maintenance Requirements", desc: "Designed for minimal upkeep, helping reduce operational costs and downtime.", image: "/obstruction-lighting/step4.png" },
    ],
  },
  industries: {
...
const ObstructionLightingSolutions = async () => {
  const rawContent = await getStoryblokStoryContent("obstruction-lighting-solutions");
  ...
  return (
    <div>
      ...
      <BlackSplitSection isBlack={false} sections={content.lowerSections} />
      <BlackSplitSection sections={content.upperSections} />
      <SingleSplitSection {...content.ledSection} isBlack={false} />
      <InstallationProcess title={content.steps.title} description={content.steps.description} steps={content.steps.steps} />
      ...
      />
      <CTASection heading={content.cta.heading} description={content.cta.description} buttonText={content.cta.buttonText} buttonHref={content.cta.buttonHref} />
    </div>
  );
};
