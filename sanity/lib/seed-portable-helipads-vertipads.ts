...
import { portableHelipadsVertipadsDefaults } from "./portable-helipads-vertipads-defaults"
...
async function main() { const document = await replaceImages({ ...portableHelipadsVertipadsDefaults, _id: "portable-helipads-vertipads-page", _type: "portableHelipadsVertipadsPage", seoTitle: "Portable Helipads & Vertipads", seoDescription: "Portable Helipads & Vertipads" }); await client.createOrReplace(document); await client.delete("page-portable-helipads-and-vertipads"); console.log("Seeded only Portable Helipads & Vertipads") }
