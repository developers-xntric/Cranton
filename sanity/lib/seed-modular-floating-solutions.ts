...
import { modularFloatingSolutionsDefaults } from "./modular-floating-solutions-defaults"
...
async function main() { const document = await replaceImages({ ...modularFloatingSolutionsDefaults, _id: "modular-floating-solutions-page", _type: "modularFloatingSolutionsPage", seoTitle: "Modular Floating Solutions", seoDescription: "Modular Floating Solutions" }); await client.createOrReplace(document); await client.delete("page-modular-floating-solutions"); console.log("Seeded only Modular Floating Solutions") }
