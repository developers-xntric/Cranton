...
import { portableLightingSolutionsDefaults } from "./portable-lighting-solutions-defaults"
...
async function main() { const document = await replaceImages({ ...portableLightingSolutionsDefaults, _id: "portable-lighting-solutions-page", _type: "portableLightingSolutionsPage", seoTitle: "Portable Lighting Solutions", seoDescription: "Portable Lighting Solutions" }); await client.createOrReplace(document); await client.delete("page-portable-lighting-solutions"); console.log("Seeded only Portable Lighting Solutions") }
